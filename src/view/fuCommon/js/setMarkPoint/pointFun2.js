...
export const dealBj2 = (deal_data, deal_data2, this_time, this_data) => {
  let array1 = [];
  let type1 = ["买进", "卖出", "持有", "加仓", "等待"];
...
export const dealYl2 = (deal_data, deal_data2, this_time, this_data) => {
  let array1 = [];
  //使用比例来计算
  deal_data.forEach((item, index) => {
    //数值的范围
...
export const dealBx2 = (deal_data, deal_data2, this_time, this_data) => {
  let array1 = [];
  let data1_max = Math.max(...deal_data);
  let data1_min = Math.min(...deal_data);
  let data1_max2 = Math.max(...deal_data2);
...
export const dealGf2 = (deal_data, deal_data2, this_time, this_data) => {
  let array1 = [];
  let data1_max = Math.max(...deal_data);
  let data1_min = Math.min(...deal_data);
  let data1_max2 = Math.max(...deal_data2);
...
export const dealMt2 = (deal_data, deal_data2, this_time, this_data) => {
  let array1 = [];
  let data1_max = Math.max(...deal_data);
  let data1_min = Math.min(...deal_data);
  let data1_max2 = Math.max(...deal_data2);
...
export const dealXp2 = (deal_data, deal_data2, this_time, this_data) => {
  let array1 = [];
  let data1_max = Math.max(...deal_data);
  let data1_min = Math.min(...deal_data);
  let data1_max2 = Math.max(...deal_data2);
...
export const dealXny2 = (deal_data, deal_data2, this_time, this_data) => {
