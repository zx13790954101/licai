<template>
  <div class="Collapse">
    <h3>国内经济数据(目期和前期对比和下一期时间)</h3>
    <el-collapse v-model="activeNames" @change="handleChange">
      <el-collapse-item name="1">
        <template slot="title">
          <div>
            <article class="head-title">
              m1和m2数据<i class="header-icon el-icon-info"></i>
              <b>(每次公布的数据是每个月的15号)</b>
            </article>
            <article>
              <b>--(m1同比上期上涨)</b>
      ...
      <el-collapse-item name="2">
        <template slot="title">
          <div>
            <article class="head-title">
              cpi和ppi数据<i class="header-icon el-icon-info"></i>
              <b>(每次公布的数据是每个月的15号)</b>
            </article>
            <article>
              <b>--(m1同比上期上涨)</b>
      ...
      <el-collapse-item name="3">
        <template slot="title">
          <div>
            <article class="head-title">
              cpi和猪肉价格<i class="header-icon el-icon-info"></i>
              <b>(每次公布的数据是每个月的15号)</b>
            </article>
            <article>
              <b>--(m1同比上期上涨)</b>
      ...
      <el-collapse-item name="4">
        <template slot="title">
          <div>
            <article class="head-title">
              cpi和gdp<i class="header-icon el-icon-info"></i>
              <b>(每次公布的数据是每个月的15号)</b>
            </article>
            <article>
              <b>--()</b>
