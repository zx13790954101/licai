  ...
  data: function () {
    ...
    return {
      ...
      config: {
        ...
        lunarCalendar: true,
        height: 'parent',//parent
        //  contentHeight: '200px',//parent
        locale: 'zh-cn',
        buttonText: {
          today: '今天',
          month: '月',
        ...
        customButtons: {
          ...
          hide: {
            text: '隐藏农历',
            click: function () {
              self.$refs.calendar2.fireMethod('option', {
                lunarCalendar: false
              })
              self.$refs.calendar2.fireMethod('option', {
                header: {
      ...
      config2: {
        ...
        customButtons: {
          ...
          hide: {
            text: '隐藏农历',
            click: function () {
              self.$refs.calendar3.fireMethod('option', {
                lunarCalendar: false
              })
              self.$refs.calendar3.fireMethod('option', {
                header: {
